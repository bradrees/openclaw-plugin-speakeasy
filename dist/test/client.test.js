...
function createJwt(expiresInMs, extra = {}) {
...
describe("client auth", () => {
    it("uses the configured access token for initial requests", async () => {
        ...
        expect(fetchImpl).toHaveBeenCalledWith(new URL("/api/v1/agent/topics", "https://speakeasy.example.com"), expect.objectContaining({
            method: "GET",
    ...
    it("refreshes expired access tokens before sending the request", async () => {
        ...
        await client.listTopics();
        expect(fetchImpl).toHaveBeenNthCalledWith(1, new URL("/api/v1/agent_sessions/refresh", "https://speakeasy.example.com"), expect.objectContaining({
            method: "POST",
            headers: expect.objectContaining({
        ...
        expect(fetchImpl).toHaveBeenNthCalledWith(2, new URL("/api/v1/agent/topics", "https://speakeasy.example.com"), expect.objectContaining({
            method: "GET",
            headers: expect.objectContaining({
    ...
    it("retries the request after a 401 and stores rotated refresh state", async () => {
        ...
        await client.listTopics();
        expect(fetchImpl).toHaveBeenNthCalledWith(3, new URL("/api/v1/agent/topics", "https://speakeasy.example.com"), expect.objectContaining({
            method: "GET",
            headers: expect.objectContaining({
    ...
    it("logs manual reauth and enters cooldown when refresh is rejected", async () => {
        ...
        expect(logger.warn).toHaveBeenCalledWith("Speakeasy automatic auth recovery is unavailable; manual reauth is required", expect.objectContaining({
